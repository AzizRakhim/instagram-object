let elStories = [
  {
    id : 1,
    media : [
      "../media/the-best-it-school.jpg",
    ],
    title : "«Najot Ta'lim» markazi «Eng yaxshi IT maktab» nominatsiyasi g'olibi bo'ldi!",
    desc : `O'zbekistondagi xususiy ta'lim salohiyatini yanada rivojlantirish maqsadida EduOn va Oliygoh.uz hamkorligida "Edu-Branding" tanlovi e'lon qilingan edi.
    <br><br>
  ...
  },
  {
    id : 2,
    media : [
      "../media/design-battle-winners.jpg",
      "../media/video-one.mp4"
    ],
    title : "Dizayn battle g'oliblari aniqlandi",
    desc : `Bir necha kun oldin xabar berganimizdek, 26-mart kuni markazimizning Xadra filialida «Najot Ta'lim» va «Progress Academy» o'quvchilari o'rtasida dizayn yo'nalishi bo'yicha battle bo'lib o'tdi.
    <br><br>
  ...
  },
  {
    id : 4,
    media : [
      "../media/grant-and-exam.jpg",
      "../media/video-two.mp4"
    ],
    title : "@najottalim jamoasi bilan birga Samarqand viloyatiga safar qildik!",
    desc : `Men Najot Ta’lim jamoasiga birgaliklari uchun, ta’limni rivojlantirishda qo’shayotgan hissalari uchun va albatta bugun sayohat uchun tashakkur izhor qilaman! Boringizga shukr! )
    <br><br>
  ...
  },
  {
    ...
    desc : `Xabaringiz bor, Najot Ta'lim markazida 5-mart sanasidan boshlab, haftaning har shanba kuni dizayn sohasining bo'lajak vakillarini saralab olish uchun dizayn foundation bosqichi imtihonlari bo'lib o'tdi. Jumladan, bugun ham imtihonlar tashkil etildi.
    <br><br>
